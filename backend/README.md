...
## Project Structure
    ...
    ├── testapiautosetting_125100  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125100`
...
2. Clone this repo and `cd testapiautosetting_125100`
